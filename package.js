...
Package.onUse(function (api) {
  ...
  api.use('clinical:hl7-resource-goal@1.3.9');
  api.use('clinical:hl7-resource-condition@1.7.26');
  api.use('clinical:hl7-resource-medication@1.3.10');
  api.use('clinical:hl7-resource-patient@3.4.20');
