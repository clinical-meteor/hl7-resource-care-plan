...
Package.onUse(function (api) {
  ...
  api.use('clinical:hl7-resource-goal@1.3.8');
  api.use('clinical:hl7-resource-condition@1.7.25');
  api.use('clinical:hl7-resource-medication@1.3.7');
  api.use('clinical:hl7-resource-patient@3.4.17');
